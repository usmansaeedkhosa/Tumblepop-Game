# Tumblepop-Game
##### A 2D platformer made in C++ with SFML, built as the final project for Programming Fundamentals (Fall 2025).
The player moves through a tile-based level (#) and uses a directional vacuum to capture roaming ghosts and skeletons.
